...
This project is a basic starter webapp made using the Angular Quickstart tutorial found 
[here]((https://angular.io/docs/ts/latest/quickstart.html). Below is the README generated by the quickstart source
code, with install instructions from that guide.
